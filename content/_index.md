...
blocks:
  - type: informations
    ...
    heading:
      ...
      text: Développé en collaboration avec des professionnels.
    items:
      - title: Ultra rapide
  ...
  - type: figure
    ...
    heading:
      ...
      text: Configuration sur mesure permettant la mise à jour de votre site Web.
    figure:
      src: https://res.cloudinary.com/uncinq/image/upload/v1758126305/screenshot-hugolify-decapcms-home_ynatqv.png
      screenshot: true
      legend:
        Page d’accueil de l’espace de gestion de contenu
